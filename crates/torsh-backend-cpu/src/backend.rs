...
use torsh_backends::{
    Backend, BackendError, BackendResult, Buffer, BufferDescriptor, Device, Kernel,
    KernelDescriptor, MemoryManager, Profiler,
};
...
impl Backend for CpuBackend {
    ...
    async fn copy_buffer(
        ...
        unsafe {
            std::ptr::copy_nonoverlapping(src_ptr.add(src_offset), dst_ptr.add(dst_offset), size);
        }
