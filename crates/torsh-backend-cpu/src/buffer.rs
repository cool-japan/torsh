...
use torsh_backends::{BackendError, BackendResult, Buffer, BufferDescriptor, BufferUsage, Device};
...
impl CpuBuffer {
    ...
    pub fn new_buffer(device: Device, descriptor: &BufferDescriptor) -> BackendResult<Buffer> {
        ...
        let data_ptr = {
            let data_guard = cpu_buffer
                .data
                .read()
                .map_err(|_| BackendError::MemoryError {
