...
impl PyAdam {
    #[new]
    #[pyo3(signature = (params, lr=0.001, betas=(0.9, 0.999), eps=1e-8, weight_decay=0.0, amsgrad=false))]
    fn new(
        params: Vec<PyTensor>,
        lr: f32,
        betas: (f32, f32),
...
impl PyAdamW {
    #[new]
    #[pyo3(signature = (params, lr=0.001, betas=(0.9, 0.999), eps=1e-8, weight_decay=0.01, amsgrad=false))]
    fn new(
        params: Vec<PyTensor>,
        lr: f32,
        betas: (f32, f32),
...
mod tests {
    ...
    fn test_adam_creation() {
        Python::with_gil(|py| {
            ...
            let adam = PyAdam::new(
                params, 0.001, (0.9, 0.999), 1e-8, 0.0, false
            );
