...
pub fn backward<T>(tensor: &Tensor<T>, gradient: Option<&Tensor<T>>, retain_graph: bool) -> Result<()> 
where
...
pub mod prelude {
    ...
    pub use crate::functional::{jacobian, hessian, vjp, jvp};
